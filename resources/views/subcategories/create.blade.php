        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/subs/{{ $category['id'] }}/create" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="5" placeholder="Podaj opis description" required></textarea>
                            </div>
